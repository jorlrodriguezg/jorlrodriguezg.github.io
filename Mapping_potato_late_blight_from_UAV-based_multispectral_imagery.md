...
```
    ...
    [Parallel(n_jobs=2)]: Done 446 tasks      | elapsed:   38.2s
    [Parallel(n_jobs=2)]: Done 500 out of 500 | elapsed:   42.6s finished
    [Parallel(n_jobs=2)]: Using backend ThreadingBackend with 2 concurrent workers.
...
![png](Images/mapping1/output_24_2.png)
...
![png](Images/mapping1/output_24_4.png)



![png](Images/mapping1/output_24_5.png)
...
![png](Images/mapping1/output_26_0.png)
...
![png](Images/mapping1/output_27_1.png)
...
```python
ds_ground_truth = gdal.Open('Validacion/Raster/Ground_truth_2018-05-12_.tif')
...
![png](Images/mapping1/output_30_0.png)



![png](Images/mapping1/output_30_1.png)
...
```
    ...
    Late blight afected area:  447.54 square meters
    Healthy potato area:  348.48 square meters
    Late blight vs Healthy potato area ratio:  1.28
    Late blight area vs total area:  0.56
    Healthy potato area vs total area:  0.44
...
```
               ...
               0       1.00      0.95      0.97   4214854
     Late blight       0.55      0.93      0.69    436912
         Healthy       0.87      0.67      0.76    340210
    
        accuracy                           0.93   4991976
       macro avg       0.81      0.85      0.81   4991976
    weighted avg       0.95      0.93      0.93   4991976
...
```
    ...
    Late blight afected area:  764.13 square meters
    Healthy potato area:  267.9 square meters
    Late blight vs Healthy potato area ratio:  2.85
    Late blight area vs total area:  0.74
    Healthy potato area vs total area:  0.26
...
```
               ...
               0       1.00      0.95      0.97   4214854
     Late blight       0.53      0.83      0.65    436912
         Healthy       0.71      0.67      0.69    340210
    
        accuracy                           0.92   4991976
       macro avg       0.75      0.82      0.77   4991976
    weighted avg       0.94      0.92      0.92   4991976
...
```
    ...
    Late blight afected area:  705.11 square meters
    Healthy potato area:  326.92 square meters
    Late blight vs Healthy potato area ratio:  2.16
    Late blight area vs total area:  0.68
    Healthy potato area vs total area:  0.32
...
```
               ...
               0       1.00      0.95      0.97   4214854
     Late blight       0.54      0.89      0.67    436912
         Healthy       0.83      0.70      0.76    340210
    
        accuracy                           0.92   4991976
       macro avg       0.79      0.84      0.80   4991976
    weighted avg       0.95      0.92      0.93   4991976
...
```
    ...
    Late blight afected area:  737.04 square meters
    Healthy potato area:  294.99 square meters
    Late blight vs Healthy potato area ratio:  2.5
    Late blight area vs total area:  0.71
    Healthy potato area vs total area:  0.29
...
```
               ...
               0       1.00      0.95      0.97   4214854
     Late blight       0.54      0.89      0.67    436912
         Healthy       0.82      0.70      0.76    340210
    
        accuracy                           0.92   4991976
       macro avg       0.79      0.85      0.80   4991976
    weighted avg       0.95      0.92      0.93   4991976
...
```
    ...
    Late blight afected area:  733.6 square meters
    Healthy potato area:  298.42 square meters
    Late blight vs Healthy potato area ratio:  2.46
    Late blight area vs total area:  0.71
    Healthy potato area vs total area:  0.29
...
```
               ...
               0       1.00      0.95      0.97   4214854
     Late blight       0.53      0.90      0.67    436912
         Healthy       0.82      0.65      0.72    340210
    
        accuracy                           0.92   4991976
       macro avg       0.79      0.83      0.79   4991976
    weighted avg       0.95      0.92      0.93   4991976
...
```
    ...
    Late blight afected area:  758.68 square meters
    Healthy potato area:  273.35 square meters
    Late blight vs Healthy potato area ratio:  2.78
    Late blight area vs total area:  0.74
    Healthy potato area vs total area:  0.26
